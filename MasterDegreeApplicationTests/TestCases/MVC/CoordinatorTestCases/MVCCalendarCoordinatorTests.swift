//
//  MVCCalendarCoordinatorTests.swift
...
class MVCCalendarCoordinatorTests: XCTestCase {
    ...
    private func createCoordinatorAndStart() -> MVCCalendarCoordinator {
        let VC = UITabBarController()
        let coordinator = MVCCalendarCoordinator(context: ContextBuilder().build())
